...
<section id="" class="card">
  <form class="" action="{{ route('sp.bill.create', ['id' => $cart->id, 'service_id'=>$cart->service_id, 'sp_id'=>$cart->sp_id])}}" method="post">
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                        ...
                        <tbody>
                              ...
                              <tr>
                                <td class=""><b><input type="text" size="5" name="" value="{{$cart->laundry_weight}}"></b> pounds</td>
                                <td class="">X</td>
                                <td class="">
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                  @foreach($drycleaning as $drycleaning)
                                      <tr>
                                        <td class="">
                                          <input type="text" size="5" name="{{$drycleaning->name}}" value="">
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                  ...
                                  @foreach( $tailoring as $tailoring )
                                      <tr>
                                        <td class="">
                                        <input type="text" size="5" name="{{$tailoring->name}}" value="">
