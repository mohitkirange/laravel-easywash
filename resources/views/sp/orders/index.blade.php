                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('sp.orders.view', ['cart_id' => $cart->id, 'service_id'=>$cart->service_id, 'sp_id'=>$cart->sp_id])}}" class="btn btn-warning  mr-1 mb-1">View</a></td>
                              <td><a href="{{ route('sp.orders.status', ['cart_id' => $cart->id, 'service_id'=>$cart->service_id, 'sp_id'=>$cart->sp_id])}}" class="btn btn-info  mr-1 mb-1">Status</a></td>
                            </tr>
                            @endforeach
