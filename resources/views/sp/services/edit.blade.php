  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-xs-12 mb-1">
        <h2 class="content-header-title">Edit Service Details</h2>
      </div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title" id="basic-layout-form-center">Edit service details</h4>
          ...
          <div class="card-body collapse in">
            <div class="card-block">
              ...
              <form class="form" action="{{route('sp.services.update', ['id' => $service->id ]) }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
                <div class="row">
                  <div class="col-md-6 offset-md-3">
                    <div class="form-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="eventInput1" class="form-control" placeholder="Bussiness name" value="{{$service->name}}" name="name">
                      </div>

                      <div class="form-group">
                        <label for="address">Bussiness address</label>
                        <input type="text" id="eventInput2" class="form-control" placeholder="Bussiness address" value="{{$service->address}}" name="address">
                      </div>

                      <div class="form-group">
                        <label for="city">City</label>
                        <input type="text" id="eventInput3" class="form-control" placeholder="City" value="{{$service->city}}" name="city">
                      </div>

                      <div class="form-group">
                        <label for="State">State</label>
                        <input type="text" id="eventInput3" class="form-control" placeholder="State" value="{{$service->state}}" name="state">
                      </div>

                      <div class="form-group">
                        <label for="zipcode">Zip Code</label>
                        <input type="text" id="eventInput3" class="form-control" pattern= "[0-9]{5}" placeholder="Zip Code" value="{{$service->zipcode}}" name="zipcode">
                      </div>
                      ...
                      <div class="form-group">
                        <label for="Services">Provided Services</label>

                          @foreach($categories as $category)
                        <div class="input-group">
                          <label class="display-inline-block custom-control ml-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <textarea rows="5" cols="5" id="eventInput4" class="form-control" placeholder="Additional Information" value="{{$service->content}}" name="content"></textarea>
                        </div>
                ...
                <div class="form-actions center">
                  ...
                  <button type="submit" class="btn btn-primary">
                    <i class="icon-check2"></i> Update Service
                  </button>
                </div>
              </form>
