  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-xs-12 mb-1">
        <h2 class="content-header-title">Service Details</h2>
      </div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title" id="basic-layout-form-center">Service details</h4>
                  ...
                  <div class="col-md-6 offset-md-3">
                    <div class="form-body">
                      ...
                      <div class="form-group">
                        <label for="name">Bussiness name: </label> {{$service->name}}
                        </div>

                      <div class="form-group">
                        <label for="address">Bussiness address: </label>{{$service->address}}
                        </div>

                      <div class="form-group">
                        <label for="city">City: </label>{{$service->city}}
                        </div>

                      <div class="form-group">
                        <label for="State">State: </label>{{$service->state}}
                        </div>

                      <div class="form-group">
                        <label for="zipcode">Zip Code: </label>{{$service->zipcode}}
                          </div>

                      <div class="form-group">
                        <label for="featured">Featured Image: </label><img src="{{$service->featured}}" alt="Logo" width="50px" height="50px">
                            </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="content">Additional Information:</label><br>{{$service->content}}
                            </div>
