    ...
    <div class="content-body"><!-- Description -->
      ...
      <div class="card-body collapse in">
          <div class="card-block">
              <div class="card-text">
                <p>This page display list of all the services you have posted on easywash </p>
                    </div>
          </div>
      </div>
      </section>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('sp.service.info', ['id' => $service->id])}}" class="btn btn-info  mr-1 mb-1">Info</a></td>
