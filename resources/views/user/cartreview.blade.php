                  ...
                  <div class="col-md-12">
                              ...
                              <dl class="accordion">
                                ...
                                <dd>
                                  ...
                                  <p class="text-uppercase"><b>Service requested on:</b> {{$carts->dos}}</p>
                                </dd>
                                <dt><a href="">Order Details</a></dt>
                                    ...
                                    <ul class="portfolio-meta m-bot-30 pull-left">
                                        <li> <span> <img class="" src="http://i76.imgup.net/accepted_c22e0.png"></span> @include('user.payment.form')</li>
                                      </ul>
