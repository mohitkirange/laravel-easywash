  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-xs-12 mb-1">
        <h2 class="content-header-title">Create new Category</h2>
      </div>
...
<section id="description" class="card">
  <div class="card-header">
    <h4 class="card-title" id="basic-layout-form-center">Update Workingday</h4>
        ...
        <div class="card">
          ...
          <div class="card-body collapse in">
            <div class="card-block">
              ...
              <form class="form" action="{{route('admin.workingdays.update', ['id' => $workingday->id] ) }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
                <div class="row">
                  <div class="col-md-6 offset-md-3">
                    <div class="form-body">
                      ...
                      <div class="form-group">
                        <label for="name">workingday name</label>
                        <input type="text" id="eventInput1" class="form-control" placeholder="workingday name" name="name" value="{{ $workingday->name}}">
                      </div>
