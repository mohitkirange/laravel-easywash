  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-xs-12 mb-1">
        <h2 class="content-header-title">Edit tailoring item</h2>
      </div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title" id="basic-layout-form-center">Edit tailoring item</h4>
          ...
          <div class="card-body collapse in">
            <div class="card-block">
              ...
              <form class="form" action="{{route('admin.items.tailoring.update', ['id' => $tailoring->id] ) }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
                <div class="row">
                  <div class="col-md-6 offset-md-3">
                    <div class="form-body">
                      <div class="form-group">
                        ...
                        <input type="text" id="eventInput1" class="form-control" placeholder="Item name" name="name" value="{{ $tailoring->name}}">
                      </div>
                ...
                <div class="form-actions center">
                  ...
                  <button type="submit" class="btn btn-primary">
                    <i class="icon-check2"></i> Update tailoring item
                  </button>
                </div>
              </form>
