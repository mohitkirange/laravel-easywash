...
<!-- <section id="description" class="card">
  <div class="card-header">
    <h4 class="card-title" id="basic-layout-form-center">Update Category: {{ $category-> name}}</h4>
        ...
        <div class="card">
          ...
          <div class="card-body collapse in">
            <div class="card-block">
              ...
              <form class="form" action="{{route('admin.categories.update', ['id' => $category->id] ) }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
                <div class="row">
                  <div class="col-md-6 offset-md-3">
                    <div class="form-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="eventInput1" class="form-control" placeholder="category name" name="name" value="{{ $category->name}}">
                      </div>
