...
<section id="description" class="card">
  <div class="card-header">
    <h4 class="card-title" id="basic-layout-form-center">Create New Category</h4>
...
<div class="card-body collapse in">
    <div class="card-block">
        <div class="card-text">
            <p>Use this page to create new category. Submitting following form will create new category.</p>
        </div>
    </div>
</div>
</section>
              ...
              {{ csrf_field() }}
                  ...
                  <div class="col-md-6 offset-md-3">
                    <div class="form-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="eventInput1" class="form-control" placeholder="category name" name="name">
                      </div>
                ...
                <div class="form-actions center">
                  ...
                  <button type="submit" class="btn btn-primary">
                    <i class="icon-check2"></i> Create category
                  </button>
                </div>
              </form>
