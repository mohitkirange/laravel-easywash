...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Advance Chart Cards - Robust Free Bootstrap Admin Template</title>
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="#"><i class="icon-whatshot"></i><span data-i18n="nav.advance_cards.main" class="menu-title">Advance Cards</span></a>
            <ul class="menu-content">
              ...
              <li class="active"><a href="card-charts.html" data-i18n="nav.cards.card_charts" class="menu-item">Charts</a>
              </li>
            </ul>
          </li>
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">Advance Chart Cards</h2>
          </div>
...
<section id="charts-section">
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="card-block">
                                <ul class="list-inline text-xs-center">
                                    <li class="mr-1">
                                        <h6><i class="icon-circle amber"></i> <span>iOS</span></h6>
                                    </li>
                                    <li class="mr-1">
                                        <h6><i class="icon-circle indigo"></i> <span>Windows</span></h6>
                                    </li>
                                    <li class="mr-1">
                                        <h6><i class="icon-circle indo"></i> <span>Android</span></h6>
                                    </li>
                                </ul>
                                <div class="chartjs">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="card bg-deep-purple bg-darken-3">
                <div class="card-body">
                    <div class="card-block">
...
<!-- // Charts section end -->
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="../../app-assets/js/scripts/cards/card-charts.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>
